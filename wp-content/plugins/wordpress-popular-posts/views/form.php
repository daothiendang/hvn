...
<label for="<?php echo $this->get_field_id( 'cat' ); ?>"><?php _e('Categories', 'wordpress-popular-posts'); ?>:</label>
<select id="<?php echo $this->get_field_id( 'cat' ); ?>" name="<?php echo $this->get_field_name( 'cat' ); ?>" class="widefat cat_select" style="margin-bottom:5px;">
    <option value="0" <?php if ( 0 == $instance['cat'] ) echo 'selected="selected"';?>>All-categories</option>
    <option value="-1" <?php if ( -1 == $instance['cat'] ) echo 'selected="selected"'; ?>>Random</option>
</select>
<p <?php if ( -1 == $instance['cat']):?>style="display: none;"<?php endif;?>>
