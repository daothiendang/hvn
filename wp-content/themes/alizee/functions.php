...
function alizee_setup() {
	...
	register_nav_menus( array(
		'primary' => __( 'Main Menu', 'alizee' ),
		'social'  => __( 'Social Links', 'alizee' ),
		'footer'  => __( 'Footer Menu', 'alizee' ),
	) );
...
function alizee_widgets_init() {
	...
	register_sidebar( array(
		'name'          => __( 'Header', 'alizee' ),
		'id'            => 'sidebar-0',
		'description'   => '',
		'before_widget' => '<aside id="%1$s" class="header_image %2$s">',
		'after_widget'  => '</aside>',
	) );
	register_sidebar( array(
